...
interface TrabajoStore {
  ...
  trabajosByVehiculo: TrabajoDetalle[];
...
export const trabajoStore = create<TrabajoStore>((set) => ({
  ...
  // =========================
  // TRABAJOS POR VEHICULO
  // =========================
  async fetchTrabajosByVehiculo(
    vehiculoId
  ) {
    ...
    try {
      ...
      const trabajos =
        await getTrabajosByVehiculo(
          vehiculoId
        );


      set({
        trabajosByVehiculo: trabajos,
        loading: false,
      });
